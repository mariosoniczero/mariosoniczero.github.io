...
var p1=battle&&battle.p1&&battle.p1.name||'';
var p2=battle&&battle.p2&&battle.p2.name||'';
if(p1&&p2){
title=''+p1+' v. '+p2;
}else if(p1||p2){
title=''+p1+p2;
...
var pmLink='/pm-'+[user.userid,PS.user.userid].sort().join('-');
...
preact.h("p",{"class":"buttonbar"},
preact.h("button",{"class":"button disabled","data-href":pmLink},"Challenge")," ",
preact.h("button",{"class":"button","data-href":pmLink},"Chat")," ",
