...
this.subscriptions.push(this.props.room.subscribe(function(message){
if(!message)_this3.forceUpdate();else
_this3.receive(message);
}));
if(this.base){
...
receive=function receive(message){};_proto2.
...
PS.prefs.subscribeAndRun(function(){
