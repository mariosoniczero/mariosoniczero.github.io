...
function BattleSearch(){var qType=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';var formatid=arguments.length>1&&arguments[1]!==undefined?arguments[1]:'';var set=arguments.length>2?arguments[2]:undefined;this.q=undefined;this.qType='';this.defaultResults=null;this.legalityFilter=null;this.legalityLabel="Illegal";this.exactMatch=false;this.results=null;this.filters=null;this.sortCol=null;this.cur=[];this.gen=7;this.dex=Dex;this.isDoubles=false;this.isLetsGo=false;this.urlRoot='//dex.pokemonshowdown.com/';
this.qType=qType;
if(set){
...
moves;_i9<_moves.length;_i9++){var _id8=_moves[_i9];
var isViable=BattleMovedex[_id8]&&BattleMovedex[_id8].isViable;
...
abilities.length;_i11++){var _id12=abilities[_i11];
var rating=BattleAbilities[_id12]&&BattleAbilities[_id12].rating;
...
return left;
};return BattleSearch;}();BattleSearch.gen=7;BattleSearch.typeTable={pokemon:1,type:2,tier:3,move:4,item:5,ability:6,egggroup:7,category:8,article:9};BattleSearch.typeName={pokemon:'Pok&eacute;mon',type:'Type',tier:'Tiers',move:'Moves',item:'Items',ability:'Abilities',egggroup:'Egg group',category:'Category',article:'Article'};