...
function calculateADV(attacker, defender, move, field) {
    ...
    attacker.stats.spe = util_1.getFinalSpeed(ADV, attacker, field, field.attackerSide);
    defender.stats.spe = util_1.getFinalSpeed(ADV, defender, field, field.defenderSide);
    var description = {
    ...
    var damage = [];
    var result = new result_1.Result(ADV, attacker, defender, move, field, damage, description);
    if (move.bp === 0) {
        damage.push(0);
        return result;
    }
    ...
    var typeEffect1 = util_1.getMoveEffectiveness(ADV, move, defender.type1, field.defenderSide.isForesight);
    var typeEffect2 = defender.type2
        ? util_1.getMoveEffectiveness(ADV, move, defender.type2, field.defenderSide.isForesight)
        : 1;
    ...
    var isPhysical = types_1.TYPE_CHART[ADV][move.type].category === 'Physical';
    ...
    if (!attacker.hasItem('Sea Incense') && items_1.getItemBoostType(attacker.item) === move.type) {
