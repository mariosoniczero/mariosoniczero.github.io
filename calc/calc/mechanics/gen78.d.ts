...
export declare function calculateBasePowerSMSS(gen: Generation, attacker: Pokemon, defender: Pokemon, move: Move, field: Field, desc: RawDesc, isAerilate?: boolean, isPixilate?: boolean, isGalvanize?: boolean, isRefrigerate?: boolean, isNormalize?: boolean, isConflagrate?: boolean, isInfectate?: boolean): number;
export declare function calculateBPModsSMSS(gen: Generation, attacker: Pokemon, defender: Pokemon, move: Move, field: Field, desc: RawDesc, basePower: number, turnOrder: string, isAerilate?: boolean, isPixilate?: boolean, isGalvanize?: boolean, isRefrigerate?: boolean, isNormalize?: boolean, isConflagrate?: boolean, isInfectate?: boolean): number[];
