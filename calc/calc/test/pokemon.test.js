...
describe('Pokemon', function () {
    test('defaults', function () {
        var p = new pokemon_1.Pokemon(7, 'Gengar');
    ...
    test('Pokemon full', function () {
        var p = new pokemon_1.Pokemon(7, 'Suicune', {
            level: 50,
            ability: 'Inner Focus',
            item: 'Leftovers',
            nature: 'Bold',
    ...
    test('gen1', function () {
        var p = new pokemon_1.Pokemon(1, 'Tauros', {
            level: 100,
            ivs: { spc: 20, def: 16 },
            evs: { atk: 200 },
            curHP: 500
    ...
    test('getForme', function () {
        expect(pokemon_1.Pokemon.getForme(1, 'Gengar')).toBe('Gengar');
        expect(pokemon_1.Pokemon.getForme(7, 'Gengar', 'Black Sludge', 'Hypnosis')).toBe('Gengar');
        expect(pokemon_1.Pokemon.getForme(7, 'Gengar', 'Gengarite', 'Hypnosis')).toBe('Gengar-Mega');
        expect(pokemon_1.Pokemon.getForme(7, 'Charizard')).toBe('Charizard');
        expect(pokemon_1.Pokemon.getForme(7, 'Charizard', 'Charizardite X')).toBe('Charizard-Mega-X');
        expect(pokemon_1.Pokemon.getForme(7, 'Charizard', 'Charizardite Y')).toBe('Charizard-Mega-Y');
        expect(pokemon_1.Pokemon.getForme(7, 'Mewtwo', 'Choice Specs', 'Psystrike')).toBe('Mewtwo');
        expect(pokemon_1.Pokemon.getForme(7, 'Mewtwo', 'Mewtwonite X', 'Psystrike')).toBe('Mewtwo-Mega-X');
        expect(pokemon_1.Pokemon.getForme(7, 'Mewtwo', 'Mewtwonite Y', 'Psystrike')).toBe('Mewtwo-Mega-Y');
        expect(pokemon_1.Pokemon.getForme(7, 'Groudon', 'Choice Band', 'Earthquake')).toBe('Groudon');
        expect(pokemon_1.Pokemon.getForme(7, 'Groudon', 'Red Orb', 'Earthquake')).toBe('Groudon-Primal');
        expect(pokemon_1.Pokemon.getForme(7, 'Kyogre', 'Choice Specs', 'Surf')).toBe('Kyogre');
        expect(pokemon_1.Pokemon.getForme(7, 'Kyogre', 'Blue Orb', 'Surf')).toBe('Kyogre-Primal');
        expect(pokemon_1.Pokemon.getForme(7, 'Meloetta', 'Leftovers', 'Psychic')).toBe('Meloetta');
        expect(pokemon_1.Pokemon.getForme(7, 'Meloetta', 'Leftovers', 'Relic Song')).toBe('Meloetta-Pirouette');
        expect(pokemon_1.Pokemon.getForme(7, 'Rayquaza', undefined, 'Earthquake')).toBe('Rayquaza');
        expect(pokemon_1.Pokemon.getForme(7, 'Rayquaza', undefined, 'Dragon Ascent')).toBe('Rayquaza-Mega');
    });
