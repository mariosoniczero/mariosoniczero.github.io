...
};return _this4;}_inheritsLoose(MainMenuPanel,_PSRoomPanel2);var _proto3=MainMenuPanel.prototype;_proto3.focus=function focus(){var _this$base;(_this$base=this.base)==null||(_this$base=_this$base.querySelector('.formatselect'))==null||_this$base.focus();};_proto3.renderMiniRoom=function renderMiniRoom(room){var RoomType=PS.roomTypes[room.type];var Panel=RoomType||PSRoomPanel;return preact.h(Panel,{key:room.id,room:room});};_proto3.
...
FormatDropdown=function(_preact$Component){function FormatDropdown(){var _this6;for(var _len3=arguments.length,args=new Array(_len3),_key3=0;_key3<_len3;_key3++){args[_key3]=arguments[_key3];}_this6=_preact$Component.call.apply(_preact$Component,[this].concat(args))||this;_this6.
...
_this6.format=_this6.base.value;
_this6.forceUpdate();
if(_this6.props.onChange)_this6.props.onChange(e);
};return _this6;}_inheritsLoose(FormatDropdown,_preact$Component);var _proto4=FormatDropdown.prototype;_proto4.
render=function render(){
...
TeamDropdown=function(_preact$Component2){function TeamDropdown(){var _this7;for(var _len4=arguments.length,args=new Array(_len4),_key4=0;_key4<_len4;_key4++){args[_key4]=arguments[_key4];}_this7=_preact$Component2.call.apply(_preact$Component2,[this].concat(args))||this;_this7.
teamFormat='';_this7.
teamKey='';_this7.
change=function(){
if(!_this7.base)return;
_this7.teamKey=_this7.base.value;
_this7.forceUpdate();
};return _this7;}_inheritsLoose(TeamDropdown,_preact$Component2);var _proto5=TeamDropdown.prototype;_proto5.
...
TeamForm=function(_preact$Component3){function TeamForm(){var _this8;for(var _len5=arguments.length,args=new Array(_len5),_key5=0;_key5<_len5;_key5++){args[_key5]=arguments[_key5];}_this8=_preact$Component3.call.apply(_preact$Component3,[this].concat(args))||this;_this8.
...
format='';_this8.
teraPreview=false;_this8.
bestOf=false;_this8.
changeFormat=function(ev){
_this8.format=ev.target.value;
};_this8.
submit=function(ev,validate){var _window$BattleFormats2;
ev.preventDefault();
var format=_this8.format;

var teambuilderFormat=_this8.props.teamFormat||PS.teams.teambuilderFormat(format);
var teamElement=_this8.base.querySelector('button[name=team]');
...
if(_this8.teraPreview){
var hasCustomRules=format.includes('@@@');
format=""+format+(hasCustomRules?', Tera Type Preview':'@@@ Tera Type Preview');
}
if(_this8.bestOf){var _this8$base;
var _hasCustomRules=format.includes('@@@');
var value=(_this8$base=_this8.base)==null||(_this8$base=_this8$base.querySelector('input[name=bestofvalue]'))==null?void 0:_this8$base.value;
format=""+format+(_hasCustomRules?", Best of = "+value:"@@@ Best of = "+value);
}
PS.teams.loadTeam(team).then(function(){var _ref5;
(_ref5=validate==='validate'?_this8.props.onValidate:_this8.props.onSubmit)==null||_ref5(ev,format,team);
});
};_this8.
...
if(rule==='terapreview')_this8.teraPreview=checked;
if(rule==='bestof')_this8.bestOf=checked;
};_this8.
handleClick=function(ev){
var target=ev.target;
while(target&&target!==_this8.base){
if(target.tagName==='BUTTON'&&target.name==='validate'){
_this8.submit(ev,'validate');
return;
}
target=target.parentNode;
}
};return _this8;}_inheritsLoose(TeamForm,_preact$Component3);var _proto6=TeamForm.prototype;_proto6.
render=function render(){var _this$props$defaultFo,_window$BattleFormats3,_window$BattleFormats4;
...
var starred=Object.keys(starredPrefs).filter(function(id){return starredPrefs[id]===true;}).reverse();for(var _i16=0;_i16<
starred.length;_i16++){var id=starred[_i16];
...
this.props.selectType==='challenge'&&((_window$BattleFormats3=
window.BattleFormats[formatId])==null?void 0:_window$BattleFormats3.teraPreviewDefault)&&preact.h("p",null,
preact.h("label",{"class":"checkbox"},
preact.h("input",{type:"checkbox",name:"terapreview",onChange:this.toggleCustomRule}),
preact.h("abbr",{title:"Start a battle with Tera Type Preview"},"Tera Type Preview"))),
this.props.selectType==='challenge'&&((_window$BattleFormats4=
window.BattleFormats[formatId])==null?void 0:_window$BattleFormats4.bestOfDefault)&&preact.h("p",null,
preact.h("label",{"class":"checkbox"},preact.h("input",{type:"checkbox",name:"bestof",onChange:this.toggleCustomRule}),
preact.h("abbr",{title:"Start a team-locked best-of-n series"},"Best-of-",
preact.h("input",{
