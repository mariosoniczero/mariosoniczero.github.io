...
_this=_PSStreamModel.call(this)||this;_this.theme='light';_this.nogif=null;_this.noanim=null;_this.bwgfx=null;_this.nopastgens=null;_this.blockPMs=null;_this.blockChallenges=null;_this.inchatpm=null;_this.noselfhighlight=null;_this.temporarynotifications=null;_this.leavePopupRoom=null;_this.refreshprompt=null;_this.language='english';_this.chatformatting={hidegreentext:false,hideme:false,hidespoiler:false,hidelinks:false,hideinterstice:true};_this.nounlink=null;_this.ignorenicks=null;_this.ignorespects=null;_this.ignoreopp=null;_this.autotimer=null;_this.autohardcore=null;_this.rightpanelbattles=null;_this.disallowspectators=null;_this.starredformats=null;_this.showjoins=null;_this.showdebug=null;_this.showbattles=true;_this.autojoin=null;_this.ignore=null;_this.tournaments=null;_this.onepanel=false;_this.timestamps={};_this.mute=false;_this.effectvolume=50;_this.musicvolume=50;_this.notifvolume=50;_this.uploadprivacy=false;_this.afd=undefined;_this.highlights=null;_this.logtimes=null;_this.storageEngine='';_this.storage={};_this.origin="https://"+Config.routes.client;
...
if(!matched){
var mons=_team5.team.split(',').map(function(m){return{species:m,moves:[]};});
var newTeam={
name:_team5.name,
...
'part,leave,close':function(target,cmd,elem){var _room$users$PS$user$u;
var roomid=(/[^a-z0-9-]/.test(target)?toID(target):target)||this.id;
var room=PS.rooms[roomid];
var battle=room==null?void 0:room.battle;

if((room==null?void 0:room.type)==="battle"&&!battle.ended&&(_room$users$PS$user$u=room.users[PS.user.userid])!=null&&_room$users$PS$user$u.startsWith('☆')&&!battle.isReplay){
...
if((room==null?void 0:room.type)==="chat"&&room.challenging){
...
return this.add("|error|"+(e.message.substr(0,28)==='Invalid regular expression: '?e.message:'Invalid regular expression: /'+targets[_i22]+'/: '+e.message));
}
}
if(highlightList.includes(targets[_i22])){
return this.add("|error|"+targets[_i22]+" is already on your highlights list.");
}
}
...
function _class(){var _document$querySelect3,_document$getElementB;var _this11;
_this11=_PSModel.call(this)||this;_this11.down=false;_this11.prefs=new PSPrefs();_this11.teams=new PSTeams();_this11.user=new PSUser();_this11.server=new PSServer();_this11.connection=null;_this11.isOffline=false;_this11.startTime=Date.now();_this11.router=null;_this11.rooms={};_this11.roomTypes={};_this11.routes=Object.assign(Object.create(null),{"teambuilder":"*","news":"*mini-window","":"*","rooms":"*right","user-*":"*popup","viewuser-*":"*popup","volume":"*popup","options":"*semimodal-popup","*":"*right","battle-*":"*","battles":"*right","teamdropdown":"*semimodal-popup","formatdropdown":"*semimodal-popup","team-*":"*","ladder":"*","ladder-*":"*","view-*":"*","login":"*semimodal-popup","help-*":"*right","tourpopout":"*semimodal-popup","groupchat-*":"*right","users":"*popup","useroptions-*":"*popup","userlist":"*semimodal-popup","avatars":"*semimodal-popup","changepassword":"*semimodal-popup","register":"*semimodal-popup","forfeitbattle":"*semimodal-popup","replaceplayer":"*semimodal-popup","changebackground":"*semimodal-popup","confirmleaveroom":"*semimodal-popup","chatformatting":"*semimodal-popup","popup-*":"*semimodal-popup","roomtablist":"*semimodal-popup","battleoptions":"*semimodal-popup","battletimer":"*semimodal-popup","rules-*":"*modal-popup","resources":"*","game-*":"*","teamstorage-*":"*semimodal-popup","viewteam-*":"*"});_this11.leftRoomList=[];_this11.rightRoomList=[];_this11.miniRoomList=[];_this11.popups=[];_this11.room=null;_this11.panel=null;_this11.leftPanel=null;_this11.rightPanel=null;_this11.leftPanelWidth=0;_this11.mainmenu=null;_this11.dragging=null;_this11.lastMessageTime='';_this11.arrowKeysUsed=false;_this11.newsHTML=((_document$querySelect3=document.querySelector('#room-news .readable-bg'))==null?void 0:_document$querySelect3.innerHTML)||'';_this11.newsId=((_document$getElementB=document.getElementById('room-news'))==null?void 0:_document$getElementB.getAttribute('data-newsid'))||null;_this11.libsLoaded=makeLoadTracker();
...
msg.split('\n');_i29<_msg$split2.length;_i29++){var _room;var line=_msg$split2[_i29];
...
var _this$horizontalNav3=this.horizontalNav(),rooms=_this$horizontalNav3.rooms,index=_this$horizontalNav3.index;
if(index===-1)return;

var unreadRooms=rooms.filter(function(room,i){var _PS$rooms$room;return(
((_PS$rooms$room=PS.rooms[room])==null?void 0:_PS$rooms$room.isSubtleNotifying)&&(
...
var autojoins=[];
var autojoinCount=0;
var rooms=this.rightRoomList;for(var _i37=0;_i37<
