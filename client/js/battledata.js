...
return prefix+"//raw.githubusercontent.com/mariosoniczero/mariosoniczero.github.io/refs/heads/master/";
}();this.
...
this.isTotem=false;
this.isMega=!!(this.forme&&['-mega','-megax','-megay','-megag','-megasupernova','-megabluemoon'].includes(this.formeid));
